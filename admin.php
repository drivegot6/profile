...
$auth_users = array(
    'admin' => '$2y$10$I.IVnZ3vbpdvM1I3kRvakuPTlhznpjFJUzJ1K5QsFzqvvnOvQhnoa', //admin@123
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://vbstat.epizy.com" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">vbstat.epizy.com</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <p>Author: <a href="about" style="text-decoration:none;">Mrinal</a></p>
                        <p>Site: <a href="/" style="text-decoration:none;">Visit</a></p>
                        <p>Mail: <a href="mailto:vbstat.epizy@gmail.com">vbstat.epizy@gmail.com</a> </p>
                        <p></p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><a href="mailto:mrinal.vbu@gmail.com" target="_blank"><i class="fa fa-bug"></i> <?php echo lng('Report Issue') ?></a></li>
